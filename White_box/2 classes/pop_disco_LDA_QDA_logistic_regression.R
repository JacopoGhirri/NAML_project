...
# training test
# accuracy  0.8937500    1
# precision 0.9080972    1
# recall    0.8937500    1
# F1_score  0.8928079    1
...
#            training      test
# accuracy  0.9062500 0.9750000
# precision 0.9114575 0.9761905
# recall    0.9062500 0.9750000
# F1_score  0.9059524 0.9749844

#relatively good performances, but no theoretical background
...
glm_model_red <-glm(binary_genre~ zcr+rms_energy+mean_chroma+spec_flat+hf_contrast+lf_contrast ,family=binomial( link = logit ), data = train_data)
...
#           training      test
# accuracy  0.9000000 0.9500000
# precision 0.9010025 0.9545455
# recall    0.9000000 0.9500000
# F1_score  0.8999375 0.9498747
