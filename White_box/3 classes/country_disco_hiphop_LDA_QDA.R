...
data<-rbind(country_data,disco_data,hiphop_data)
  
genre<-factor(data$genre)
levels(genre)

plot(data[which(genre=="country"),1:2], col="red")
points(data[which(genre=="disco"),1:2], col="green")
points(data[which(genre=="hiphop"),1:2], col="blue")
